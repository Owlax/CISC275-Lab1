...
const yourName : String = "Alex Croce";
let yourPronouns : String = "She/Her";
const yourMajor : String = "Computer Science";
let classification : String = "Sophmore";
let oneExcite : String = "My frog website";
let anyConcerns : String = "Remebering everything as things get more complicated";
let funFact : String = "I like to sing";
